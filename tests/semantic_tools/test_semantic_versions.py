...
from action_tool.pr_version_calc import calculate_version_w_semantic_release, run_semantic_release, get_override_from_version_diff
...
def test_semantic_versions_a(mock_local_proj_a):
    ...
    next_version = calculate_version_w_semantic_release(rel_label, config_file, mock_local_proj_a)
...
def test_semantic_versions_branch(mock_local_proj_a_branch):
    ...
    calculated_next_version = calculate_version_w_semantic_release(rel_label, pr_title, config_file, mock_local_branch_dir)
